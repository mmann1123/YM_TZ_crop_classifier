...
primarily in late growing season, potentially missing spectral
signatures from earlier phenological stages that could improve
discrimination. Additionally, crop type imbalance in our dataset---with
underrepresentation of crops like peanuts, soybeans, and okra these
crops were dropped from the study. Confusion between similar crops
(e.g., cassava and maize) indicates that additional discriminative
features or more extensive training data are needed for these
...
still presents challenges for intuitive interpretation. Future work
should focus on expanding geographic coverage to assess model
transferability, incorporating multi-temporal data collection throughout
the growing season, developing methods to handle class imbalance, and
exploring more parsimonious feature sets that balance accuracy with
interpretability.
